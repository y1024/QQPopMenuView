...
//  ECLite
//
//  Created by husong on 2017/10/5.
                       ...
                       action:(void(^)(NSInteger index))action
{
    ...
    if (self = [super init]) {
        ...
        // 创建tableView
        CGFloat rightInsert = 5;
        CGFloat triangle_Y = 10;
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - width - rightInsert, point.y + triangle_Y, width, kCellHeight * array.count) style:UITableViewStylePlain];
